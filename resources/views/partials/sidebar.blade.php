        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
                    <img src="#" class="h-8 mr-3" alt="Sales Department Logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Sales</span>
                </a>
            </div>
...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 overflow-y-scroll no-scrollbar"
    aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 overflow-y-scroll no-scrollbar">
           ...
           <hr>
            ...
            <li>
                <a href="/backup"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Backup</span>
                </a>
            </li>
        </ul>
    </div>
