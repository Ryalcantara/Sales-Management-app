<!-- Edit modal -->
<div id="edit-modal_{{ $customer->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="edit-modal_{{ $customer->id }}">
                ...
                <form action="/customers/{{ $customer->id }}" method="POST">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input name="id"
                            ...
                            value="{{ $customer->id }}" placeholder=" " type="hidden">

                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <input name="customer_name"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ $customer->customer_name }}" placeholder=" " required>
                        <label
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input name="customer_type"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ $customer->customer_type }}" placeholder=" " required>
                        <label
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <input name="contact_number"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ $customer->contact_number }}" pattern="^(09|\+639)\d{9}$"
            ...
            <div class="relative z-0 w-full mb-6 group p-4">
                <button type="button" data-modal-hide="edit-modal_{{ $customer->id }}"
...
<!-- Delete modal -->
<div id="delete-modal_{{ $customer->id }}" tabindex="-1"
    class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                data-modal-hide="delete-modal_{{ $customer->id }}">
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
            ...
            <div class="p-6 text-center">
                ...
                <div class="flex justify-between">
                    <form action="/customers/{{ $customer->id }}" method="post">
                        @csrf
                        @method('delete')
                        <button type="submit" data-modal-hide="delete-modal_{{ $customer->id }}" type="button"
                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Yes, I'm sure
                        </button>
                    </form>
                    <button data-modal-hide="delete-modal_{{ $customer->id }}" type="button"
