    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="edit-modal_{{ $expense->id }}">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form action="/expenses/{{ $expense->id }}" method="POST">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input name="id" value={{ $expense->id }} type="hidden">
            ...
            <div class="relative z-0 w-full mb-6 group p-4">
                <button type="button" data-modal-hide="edit-modal_{{ $expense->id }}"
...
<div id="delete-modal_{{ $expense->id }}" tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                data-modal-hide="delete-modal_{{ $expense->id }}">
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
            ...
            <div class="p-6 text-center">
                ...
                <div class="flex justify-between">
                    ...
                    <button data-modal-hide="delete-modal_{{ $expense->id }}" type="button"
