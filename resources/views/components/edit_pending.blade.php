    ...
    <div class="w-full  rounded-lg p-4">
        ...
        <div class="px-6 py-6 lg:px-8">
            <div class="flex justify-center items-center">
                ...
                <button type="button" data-drawer-hide="edit_pending_{{ $pending->id }}"
                    aria-controls="edit_pending_{{ $pending->id }}"
            ...
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Edit Queue Sales</h3>
            ...
            <form action="/pending_sales/{{ $pending->id }}" method="POST">
                ...
                <div>
                    ...
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Other form of Payments:</h3>
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input name="gift_certificate" type="number"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required>
                            <label
                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Gift
                                Certificate:</label>
                        </div>
                    </div>
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input name="gift_voucher" type="number"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required>
                            <label
                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Gift
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input name="loyalty" type="number"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required>
                            <label
                ...
                <div class="relative z-0 w-full mb-6 group p-4 flex justify-between">
                    <button type="button"
                        ...
                        data-drawer-hide="edit_pending_{{ $pending->id }}"
                        aria-controls="edit_pending_{{ $pending->id }}">Close</button>
                    <button type="submit"
